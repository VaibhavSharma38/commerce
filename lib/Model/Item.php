...
class Model_Item extends \xepan\hr\Model_Document{
	...
	*/
	...
	function importItem1($data){
		throw new \Exception("Please do it manually", 1);
		...
		foreach ($data as $key => $record) {
			...
			foreach ($record as $field => $value) {
				...
				// 	$model_cf_asso->addCondition('order',80);
				// 	$model_cf_asso->tryLoadAny();
				...
				// 	$model_cf_asso->addCondition('item_id',$item_m->id);
				// 	$model_cf_asso->addCondition('status','Active');
				// 	$model_cf_asso->addCondition('order',10);
				// 	$model_cf_asso->tryLoadAny();
				...
				// 	$model_cf_asso->addCondition('item_id',$item_m->id);
				//     $model_cf_asso->addCondition('status','Active');
				//     $model_cf_asso->addCondition('order',30);
				// 	$model_cf_asso->tryLoadAny();
				...
				// 	$model_cf_asso->addCondition('item_id',$item_m->id);
				//     $model_cf_asso->addCondition('status','Active');
				//     $model_cf_asso->addCondition('order',50);
				// 	$model_cf_asso->tryLoadAny();
				...
				// 	$model_cf_asso->addCondition('item_id',$item_m->id);
				// 	$model_cf_asso->addCondition('status','Active');
				// 	$model_cf_asso->addCondition('order',90);
				// 	$model_cf_asso->tryLoadAny();
				...
				// 	$model_cf_asso->addCondition('item_id',$item_m->id);
				//  	$model_cf_asso->addCondition('status','Active');
				// 	$model_cf_asso->addCondition('order',60);
				// 	$model_cf_asso->tryLoadAny();
				...
				// 	$model_cf_asso->addCondition('item_id',$item_m->id);
				//  	$model_cf_asso->addCondition('status','Active');
				//  	$model_cf_asso->addCondition('order',40);
				// 	$model_cf_asso->tryLoadAny();
				...
				// 	$model_cf_asso->addCondition('item_id',$item_m->id);
				//  	$model_cf_asso->addCondition('status','Active');
				//  	$model_cf_asso->addCondition('order',100);
				...
				// 	$spec_m = $this->add('xepan\commerce\Model_Item_Specification');
				// 	$spec_m->loadBy('name','Collection');
					
				// 	$model_cf_asso = $this->add('xepan\commerce\Model_Item_CustomField_Association');
				// 	$model_cf_asso->addCondition('customfield_generic_id',$spec_m->id);
				// 	$model_cf_asso->addCondition('item_id',$item_m->id);
				//  	$model_cf_asso->addCondition('status','Active');
				//  	$model_cf_asso->addCondition('order',20);
				// 	$model_cf_asso->tryLoadAny();
				...
				// 	$model_cf_asso->addCondition('item_id',$item_m->id);
				//  	$model_cf_asso->addCondition('status','Active');
				//  	$model_cf_asso->addCondition('order',70);
